...
class JointOffset:
    ...
    @dispatch(str, str, list, list, int, str)
    def __init__(self, name: str, parent_name: str, children_names: list, offset: list, channel: int, order: str):
        self.name = name
        self.parent_name = parent_name
        self.children_names = children_names.copy()
...
class JointMotion:
    ...
    @dispatch(str, list)
    def __init__(self, name: str, motion: list):
        self.name = name
        self.data = motion.copy()
